...
public class CustomGuiNewChat extends GuiNewChat {
    ...
    public IChatComponent getChatComponent(int mouseX, int mouseY) {
        IChatComponent component = super.getChatComponent(mouseX, mouseY);
    ...
    private void handleChatClick(IChatComponent component) {
        String text = StringUtils.stripControlCodes(component.getUnformattedText());
        StringSelection selection = new StringSelection(text);
        Toolkit.getDefaultToolkit().getSystemClipboard().setContents(selection, selection);
        // 通知
        mc.thePlayer.addChatMessage(new net.minecraft.util.ChatComponentText("§b[WVC]§f Message copied to clipboard!"));
    }
}
