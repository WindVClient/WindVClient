...
public class HudRenderer {
    ...
    public static void renderLogo() {
        ...
        // 解像度キャッシュ更新
        if (cachedSr == null || mc.displayWidth != lastWidth || mc.displayHeight != lastHeight) {
            cachedSr = new net.minecraft.client.gui.ScaledResolution(mc);
            lastWidth = mc.displayWidth;
            lastHeight = mc.displayHeight;
        }
        
        int guiWidth = cachedSr.getScaledWidth();
        int guiHeight = cachedSr.getScaledHeight();
        ...
        // 2:1 の比率で描画
        net.minecraft.client.gui.Gui.drawModalRectWithCustomSizedTexture(x, y, 0, 0, logoW, logoH, logoW, logoH);
