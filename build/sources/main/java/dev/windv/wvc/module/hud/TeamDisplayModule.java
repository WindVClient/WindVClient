...
public class TeamDisplayModule extends WVCModule {
    ...
    public void onRender(RenderGameOverlayEvent.Post event) {
        ...
        // 自分の名前の色（チーム色）を取得
        String myFormatted = mc.thePlayer.getDisplayName().getFormattedText();
        ...
        for (EntityPlayer player : mc.theWorld.playerEntities) {
            ...
            String playerFormatted = player.getDisplayName().getFormattedText();
        ...
        for (EntityPlayer teammate : teammates) {
            float health = teammate.getHealth();
    ...
    private boolean isNPC(EntityPlayer player) {
        ...
        return Minecraft.getMinecraft().getNetHandler().getPlayerInfo(player.getUniqueID()) == null;
    }
