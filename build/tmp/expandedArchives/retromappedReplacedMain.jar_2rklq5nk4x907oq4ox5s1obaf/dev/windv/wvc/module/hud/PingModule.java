...
public class PingModule extends WVCModule {
    ...
    private int fetchPing(Minecraft mc) {
        if (mc.func_71356_B()) return 0;
        
        try {
            // 接続が確立され、プレイヤー情報が完全に準備できるまで待機
            if (mc.func_147114_u() != null && mc.field_71439_g != null && mc.func_147114_u().func_175102_a(mc.field_71439_g.func_110124_au()) != null) {
                NetworkPlayerInfo info = mc.func_147114_u().func_175102_a(mc.field_71439_g.func_110124_au());
                if (info != null) return info.func_178853_c();
            }
            
            // 予備の取得方法
            if (mc.func_147104_D() != null) return (int) mc.func_147104_D().field_78844_e;
